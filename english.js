...
const data = require('./data/data-english.json')
...
(async function() {
    try{
        ...
        const content = await compile('english',data) 
        await page.setContent(content,{ waitUntil: "networkidle0" });
        await page.emulateMediaType('screen');
        await page.addStyleTag({ path: './css/style.pdf.English.css'});
